...
```{r}
gapminder %>%
  mutate(gdp = gdpPercap * pop, gdpBill = round(gdp/1000000000,2))
```
...
```{r}
gapminder %>%
  transmute(gdp = gdpPercap * pop, gdpBill = round(gdp/1000000000,2))
```
...
```{r}
gapminder %>%
  mutate(liefeExp = if_else(country == "Canada" & year == 1952, 70, lifeExp))
```

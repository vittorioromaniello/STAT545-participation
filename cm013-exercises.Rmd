...
- Weak: lots of things go wrong with the plot. Biased towards making germany stand out. It is only an average and range on x-axis is made in such a way that makes the difference between germany and the rest seem larger. After all germany has less than 1 hour more of work than other countries below it.

- Main takeaway: Show entire x-axis, number of people average was taken over. Result of average was good to have in the first graph.
...
- Main takeaway: proper y-scale and label the x-axis.
...
- Very weak: plot is reversed, red-background is misleading.

- Main takeaway: colours are important in a graph. Axes in the right way, 0 in bottom left. Don't get too creative with axes.
